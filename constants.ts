  ...
  't7': [
    {
      ...
      explanationCorrect: 'Las costillas 11ª y 12ª son flotantes porque no se unen al esternón ni directa ni indirectamente.',
      explanationIncorrect: 'Las costillas 11ª y 12ª son flotantes porque no se unen al esternón ni directa ni indirectamente.'
    },
    {
      id: 'q2',
      topicId: 't7',
      ...
      explanationCorrect: 'El manubrio del esternón posee las escotaduras claviculares para articularse con las clavículas.',
      explanationIncorrect: 'El manubrio del esternón posee las escotaduras claviculares para articularse con las clavículas.'
    },
    {
      id: 'q3',
      topicId: 't7',
      ...
      options: ['7', '12', '5', '9'],
      correctAnswerIndex: 1,
      explanationCorrect: 'Existen 12 vértebras torácicas (T1-T12) que se articulan con las costillas.',
      explanationIncorrect: 'Existen 12 vértebras torácicas (T1-T12) que se articulan con las costillas.'
    },
    {
      id: 'q4',
      topicId: 't7',
      ...
      explanationCorrect: 'La 1ª costilla es atípica; es corta, ancha, muy curva y tiene una única carilla en su cabeza para T1.',
      explanationIncorrect: 'La 1ª costilla es atípica; es corta, ancha, muy curva y tiene una única carilla en su cabeza para T1.'
    }
  ],
  't8': [
    {
      ...
      correctAnswerIndex: 1,
      explanationCorrect: 'La articulación manubrioesternal suele ser una sínfisis, lo que permite un pequeño movimiento durante la respiración.',
      explanationIncorrect: 'La articulación manubrioesternal suele ser una sínfisis, lo que permite un pequeño movimiento durante la respiración.'
    },
    {
      id: 'q_t8_2',
      topicId: 't8',
      ...
      correctAnswerIndex: 1,
      explanationCorrect: 'La articulación de la cabeza de la costilla se da con los cuerpos vertebrales de las vértebras torácicas.',
      explanationIncorrect: 'La articulación de la cabeza de la costilla se da con los cuerpos vertebrales de las vértebras torácicas.'
    }
  ],
  'g1': [
     {
      ...
      correctAnswerIndex: 1,
      explanationCorrect: 'En la posición anatómica, el cuerpo está erguido, con la mirada al frente y las palmas de las manos vueltas hacia adelante (supinación).',
      explanationIncorrect: 'En la posición anatómica, el cuerpo está erguido, con la mirada al frente y las palmas de las manos vueltas hacia adelante (supinación).'
    },
    {
      id: 'q_g1_2',
      topicId: 'g1',
      ...
      explanationCorrect: 'El plano sagital medio es el plano vertical que pasa longitudinalmente por el cuerpo, dividiéndolo en mitades derecha e izquierda.',
      explanationIncorrect: 'El plano sagital medio es el plano vertical que pasa longitudinalmente por el cuerpo, dividiéndolo en mitades derecha e izquierda.'
    }
  ]
};